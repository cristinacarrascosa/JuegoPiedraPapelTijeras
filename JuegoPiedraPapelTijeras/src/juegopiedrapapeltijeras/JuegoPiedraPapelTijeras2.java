 ...
 * @author carra
 */
public class JuegoPiedraPapelTijeras2 {
    ...
    public static int mano(int eleccionJug) {
        ...
        if (eleccionJug == eleccionPc) {
            ...
            puntos += 1;
        } else if ((eleccionPc == 1 && eleccionJug == 3) || (eleccionPc == 2 && eleccionJug == 1) || (eleccionPc == 3 && eleccionJug == 2)) { //Comprobamos si la maquina ha ganado
